            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo">
                        <img src="<?php echo site_url(); ?>assets/images/logo.png" alt="" style="max-width: 112px;">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="section-heading">
            <h2>Discover Our <em>Futur</em> &amp; <span>TALE-AI Projects</span></h2>
          ...
          <?php foreach ($resultat as $key) { ?>
            <div class="item">
              ...
              <div class="down-content">
                ...
                <a href="<?php echo site_url(); ?>Contenu_controller/detail/<?php echo $key['slug'] ?>-<?php echo $key['id'] ?>"><h4 style="color:blue;">more</h4></a>
              </div>
            </div>
            <?php } ?>
